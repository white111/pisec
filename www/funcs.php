...
function login($login, $password, $mysqli) {
   ...
   if ($stmt = $mysqli->prepare("SELECT id, username, password, salt FROM passwd WHERE username = ? LIMIT 1")) { 
...
function login_check($mysqli) {
   ...
   if(isset($_SESSION['user_id'], $_SESSION['username'], $_SESSION['login_string'])) {
     ...
     if ($stmt = $mysqli->prepare("SELECT password FROM passwd WHERE id = ? LIMIT 1")) { 
